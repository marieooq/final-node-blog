...
const articleData = {
    image: "https://images.unsplash.com/photo-1509680859026-7d8cfc6894f4?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=3900&q=80",
...
const articleHeaderStyle = {
    height: '50vh',
    background: `url("${articleData.image}")`,
